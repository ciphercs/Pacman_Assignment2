...
public class Game extends GameGrid
{
  ...
  protected src.PacManGameGrid grid = new src.PacManGameGrid(nbHorzCells, nbVertCells);
  ...
  public Game(GameCallback gameCallback, Properties properties, String mapString)
  {
    ...
    if (!mapString.isEmpty()){
      grid = new src.PacManGameGridAdapter(nbHorzCells, nbVertCells, mapString);
    }
  ...
  public void setupActorLocations(String mapString) {
    ...
    if (!mapString.isEmpty()){
      pacManX = mapString.indexOf("f")%nbHorzCells;
      pacManY = mapString.indexOf("f")/nbHorzCells;

      trollX = mapString.indexOf("g")%nbHorzCells;
      trollY = mapString.indexOf("g")/nbHorzCells;

      tx5X = mapString.indexOf("h")%nbHorzCells;
      tx5Y = mapString.indexOf("h")/nbHorzCells;
    }
